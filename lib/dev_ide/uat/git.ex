defmodule DevIDE.UAT.Git do
  @moduledoc """
  The seam for opening a self-heal proposal as a reviewable PR. `DevIDE.UAT.Proposal`
  owns *what* to propose (the diff + artifact); a `Git` implementation owns *how*
  to publish it. The default `DevIDE.UAT.Git.System` shells out to `git`/`gh`;
