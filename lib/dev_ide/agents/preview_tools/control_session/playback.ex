defmodule DevIDE.Agents.PreviewTools.ControlSession.Playback do
  @moduledoc false

  alias DevIDE.Agents.PreviewTools.ControlSession.Shared
  alias DevIDE.Agents.PreviewTools.ControlSession.SessionResolve
  alias DevIDE.Agents.PreviewTools.ControlSession.PaneOpen
  ...
  defp playback_origin do
    base_url = Application.get_env(:dev_ide, :preview_app_url) || Shared.preview_api_base_url()
