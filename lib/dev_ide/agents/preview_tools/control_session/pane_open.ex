defmodule DevIDE.Agents.PreviewTools.ControlSession.PaneOpen do
  @moduledoc false
  ...
  alias DevIDE.Agents.PreviewTools.ControlSession.Navigation
  ...
  defp preview_command(url, opts) do
    ...
    []
    |> maybe_add_preview_env("DEV_IDE_API_TOKEN", Shared.preview_api_token())
