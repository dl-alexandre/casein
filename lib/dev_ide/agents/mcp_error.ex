defmodule DevIDE.Agents.MCPError do
  ...
  @doc "Build MCP tool error payload fields from a tool error reason."
  ...
  @doc "Human-readable summary line for MCP `content`."
  ...
  @doc "Full MCP tools/call error result map."
