defmodule DevIDE.PreviewControl.Adapter do
  @moduledoc """
  Behaviour for controllable preview sessions.

  Adapters own browser/runtime state. `DevIDE.PreviewControl` enforces
  workspace URL boundaries before delegating here.
  """
