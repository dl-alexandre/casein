if Code.ensure_loaded?(Graph) and Code.ensure_loaded?(Boxart) do
  defmodule Mix.Tasks.Casein.Depgraph do
    ...
    Boxart so it is legible inside a terminal pane.
        ...
        mix casein.depgraph lib/casein/previews
        mix casein.depgraph lib/casein/previews --dir lr --dot xref_graph.dot
    ...
    def run(argv) do
      ...
      path =
        List.first(rest) ||
          Mix.raise("usage: mix casein.depgraph <path> [--dot FILE] [--dir td|lr]")
