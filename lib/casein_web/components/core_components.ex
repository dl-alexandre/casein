defmodule CaseinWeb.CoreComponents do
  @moduledoc """
  ...
  def show(js \\ %JS{}, selector) do
    JS.show(js,
      ...
      time: 300,
      transition:
        {"transition-all ease-motion-geometry duration-motion-geometry",
  ...
  def hide(js \\ %JS{}, selector) do
    JS.hide(js,
      ...
      time: 200,
      transition:
        {"transition-all ease-motion-surface duration-motion-surface",
         "opacity-100 translate-y-0 sm:scale-100",
         "opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95"}
    )
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CaseinWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CaseinWeb.Gettext, "errors", msg, opts)
    end
  end
