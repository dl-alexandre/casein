defmodule CaseinWeb.Layouts do
    ...
    <header class="navbar px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex-none">
        <ul class="flex flex-column px-1 space-x-4 items-center">
          ...
          <li>
            <.link navigate={~p"/?drawer=notifications"} class="btn btn-ghost">
  ...
  def theme_toggle(assigns) do
    ...
    <div class="card relative flex flex-row items-center border-2 border-base-300 bg-base-300 rounded-full">
      <div class="absolute w-1/3 h-full rounded-full border-1 border-base-200 bg-base-100 brightness-200 left-0 [[data-theme=light]_&]:left-1/3 [[data-theme=dark]_&]:left-2/3 transition-[left] duration-motion-state ease-motion-state" />
