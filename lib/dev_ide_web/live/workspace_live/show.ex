defmodule DevIdeWeb.WorkspaceLive.Show do
  ...
  def render(assigns) do
    ...
    <div class="flex h-[calc(100vh-1.5rem)] w-full flex-col bg-base-100 text-base-content px-4 py-2 lg:px-6 pointer-coarse:pt-[max(1.25rem,env(safe-area-inset-top))]">
