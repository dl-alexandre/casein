defmodule Casein.Terminals.SessionOwner do
  ...
  defstruct [
    ...
    # Single-flight async session_exists? probe:
    # %{ref, pid, session, timer, purpose}. purpose is :recover_if_missing
    # (drift tick) or {:continue_recover, attempts} (backend recover path).
    tmux_session_exists_probe: nil,
  ...
  # Async session_exists? probe finished.
  @impl true
