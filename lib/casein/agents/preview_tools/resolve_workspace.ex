defmodule Casein.Agents.PreviewTools.ResolveWorkspace do
  ...
  use Jido.Action,
    ...
    description:
      "Resolve a workspace_id from a manager id or a folder path. Use this when a preview tool reports workspace_not_found or when working from an attached local folder.",
    category: "preview",
    tags: ["preview"],
    vsn: "1.0.0",
    schema: [
