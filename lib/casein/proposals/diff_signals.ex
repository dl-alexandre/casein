defmodule Casein.Proposals.DiffSignals do
  @moduledoc """
  Content-level anti-gaming signals ported from the deleted `Loops` subsystem
  (`Casein.Loops.Sandbox.analyze_diff/1`, removed 2026-06-26). Loops let an
  ...
  Used as a hard, unconditional veto in `Casein.Proposals.AutoApply` (never
