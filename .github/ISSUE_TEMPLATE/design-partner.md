...
- Roughly how many agent sessions per week:
- How many repos a typical task spans:

## The pain (be specific)
- **Context loss:** what do you lose when a session/agent dies, and how often?
- **Multi-repo safety:** what's gone wrong running agents across repos?
...
- Are you open to a 30-min call where we watch your real workflow? (yes/no)
