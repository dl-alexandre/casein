...
%{
  ...
  audits: [
    %{
      version: "2.1.0",
      reviewer: "noreply@devide.local",
      notes:
        "2026-08-24 Jido provider dependency audit: Phase 1 rules 1-8 clean; mix deps.audit and mix hex.audit clean; no native or shell payloads. OSV scanner was unavailable. Operator approved safe_to_deploy.",
      package: "abnf_parsec",
      criteria: :safe_to_deploy,
      reviewed_at: ~D[2026-08-24]
    },
    %{
      version: "1.2.0",
      reviewer: "noreply@devide.local",
