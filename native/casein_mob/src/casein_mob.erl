%% casein_mob.erl — BEAM bootstrap for CaseinMob.
%% Called by the iOS/Android native launcher via -eval 'casein_mob:start().'.
...
start() ->
    ...
    step(5, fun() -> 'Elixir.CaseinMob.App':start() end),
