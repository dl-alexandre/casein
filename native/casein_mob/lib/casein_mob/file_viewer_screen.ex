defmodule CaseinMob.FileViewerScreen do
  @moduledoc """
  Read-only file viewer for the mobile IDE.

  The screen requests file bytes from `CaseinMob.HostBridge`; the host enforces
  ...
  def handle_info({:tap, :terminal}, socket),
    do: {:noreply, Mob.Socket.pop_to(socket, CaseinMob.TerminalScreen)}
