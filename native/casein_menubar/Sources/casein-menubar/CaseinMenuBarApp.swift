...
struct CaseinMenuBarApp: App {
    ...
    init() {
        ...
        let releaseNode = ProcessInfo.processInfo.environment["CASEIN_DESKTOP_RELEASE_NODE"]
            .flatMap(ReleaseController.validatedReleaseNode) ?? ReleaseController.defaultReleaseNode
