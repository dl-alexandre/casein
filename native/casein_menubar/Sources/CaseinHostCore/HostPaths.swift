...
public struct HostPaths: Sendable, Equatable {
    ...
    public var caseinBinary: URL { releaseRoot.appending(path: "bin/casein") }
    ...
    public static func detect(
        ...
        let root =
            environment["CASEIN_RELEASE_ROOT"].flatMap { $0.isEmpty ? nil : $0 }
            ?? usableBundledRoot
    ...
    static func defaultDataDir(
        ...
        let legacy = applicationSupport.appending(path: "Casein")
