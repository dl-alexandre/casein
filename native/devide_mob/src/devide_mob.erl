%% devide_mob.erl — BEAM bootstrap for DevideMob.
%% Called by the iOS/Android native launcher via -eval 'devide_mob:start().'.
...
start() ->
    ...
    step(5, fun() -> 'Elixir.DevideMob.App':start() end),
