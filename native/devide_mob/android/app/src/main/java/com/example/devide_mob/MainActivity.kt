...
class MainActivity : ComponentActivity() {
    ...
    companion object {
        private const val TAG = "DevideMob"
        init { System.loadLibrary("devide_mob") }
    }
    ...
    private fun initFirebaseFallbackIfNeeded() {
        try {
            ...
            val options = com.google.firebase.FirebaseOptions.Builder()
                .setApplicationId("1:000000000000:android:devide")
                .setApiKey("devide-unconfigured")
                .setProjectId("devide-unconfigured")
    ...
    private fun firebaseOptionsFromBuildConfig(): com.google.firebase.FirebaseOptions? {
        if (!BuildConfig.DEVIDE_FIREBASE_OPTIONS_CONFIGURED) return null

        return com.google.firebase.FirebaseOptions.Builder()
            .setApplicationId(BuildConfig.DEVIDE_FIREBASE_APPLICATION_ID)
            .setApiKey(BuildConfig.DEVIDE_FIREBASE_API_KEY)
            .setProjectId(BuildConfig.DEVIDE_FIREBASE_PROJECT_ID)
            .setGcmSenderId(BuildConfig.DEVIDE_FIREBASE_GCM_SENDER_ID)
            .build()
    }
    ...
    private fun notificationJsonFromReviewDeepLink(uri: android.net.Uri?): String? {
        if (uri?.scheme != "devide" || uri.host != "review") return null
