// build.zig — Android native build for devide_mob.
//
...
//     Output: libdevide_mob.so installed to
//     android/app/src/main/jniLibs/<abi>/libdevide_mob.so so
