defmodule DevideMob.DeviceBridge do
  @moduledoc """
  Device-side registry for the host bridge process.

  `DevideMob.HostBridge` runs on the devbox and announces its pid to this
  process. Screens use the registered pid for non-terminal IDE requests, while
  terminal bytes still flow directly to `DevideMob.TerminalScreen`.
  """
