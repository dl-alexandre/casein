...
| 23:33 | Local Mac authenticated work | A normal one-time claim creates resumable work | Claim exchange redirected to a clean URL and created scratch session `devide___scratch___u-desktop-l6hjyon5` | Green | — | Local Mac has real resumable work |
