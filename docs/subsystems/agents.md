...
| `Casein.Desktop.NativeAgentLaunch` | `lib/casein/desktop/native_agent_launch.ex` | Composes preflight, isolated worktree creation, provider MCP materialization, ConPTY session start, runtime reporting, and clean-only completion cleanup. |
