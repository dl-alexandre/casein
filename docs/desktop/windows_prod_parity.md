...
| Preview control and screenshots | Playwright sidecar and preview MCP | packaged Node/Playwright/Chromium runtime, native preview-server lifecycle, executable smoke, and repair diagnostics | Capture clean-machine agent-driven Preview MCP acceptance evidence |
