...
- Route: [`lib/casein_web/router.ex`](../lib/casein_web/router.ex)
- Picker: [`lib/casein_web/live/workspace_live/index.ex`](../lib/casein_web/live/workspace_live/index.ex)
- Workspace LiveView: [`lib/casein_web/live/workspace_live/show.ex`](../lib/casein_web/live/workspace_live/show.ex)
- Channel: [`lib/casein_web/channels/terminal_channel.ex`](../lib/casein_web/channels/terminal_channel.ex)
...
- [`lib/casein/policy.ex`](../lib/casein/policy.ex) (`can_run_command?/1`)
- [`lib/casein/commands.ex`](../lib/casein/commands.ex) (`allowlist/0`, backed by `commands/allowlist.ex`)
- [`lib/casein_web/channels/terminal_channel.ex`](../lib/casein_web/channels/terminal_channel.ex)
...
- [`lib/casein/policy.ex`](../lib/casein/policy.ex)
- [`lib/casein/audit.ex`](../lib/casein/audit.ex) (`emit_decision/2`)
...
[`session.ex`](../lib/casein/terminals/session.ex)), the subscriber is
...
- [`lib/casein/terminals/session.ex`](../lib/casein/terminals/session.ex) (`@buffer_bytes`, `subscribe` replay, `ingest/2`, `append_buffer/3`)
- [`test/casein/terminals/session_test.exs`](../test/casein/terminals/session_test.exs) (`"replays buffered output to a re-attaching subscriber"`)
...
([`Runs.Ledger`](../lib/casein/runs/ledger.ex)), live MCP activity is
recorded via [`Agents.MCPAudit`](../lib/casein/agents/mcp_audit.ex),
and the full per-workspace audit stream remains queryable.

- [`lib/casein/audit.ex`](../lib/casein/audit.ex)
- [`lib/casein/audit/event.ex`](../lib/casein/audit/event.ex)
- [`lib/casein_web/live/workspace_live/show/run_panel.ex`](../lib/casein_web/live/workspace_live/show/run_panel.ex)
