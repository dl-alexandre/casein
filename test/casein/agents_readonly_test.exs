defmodule Casein.AgentsReadOnlyTest do
  ...
  @sources [
    "lib/casein/agents.ex",
    "lib/casein/agents/local_adapter.ex",
    "lib/casein/agents/capability.ex",
    "lib/casein/agents/artifact.ex",
    "lib/casein/agents/review_command.ex",
    "lib/casein/agents/run.ex",
    "lib/casein_web/live/workspace_live/show.ex"
  ]
  ...
  test "ReviewCommand allowlist is the only argv source for agent runs" do
    src = File.read!("lib/casein/agents/run.ex")
