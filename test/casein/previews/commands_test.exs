defmodule Casein.Previews.CommandsTest do
  ...
  describe "run/4 preview errors — configured preview_tools seam" do
    test "routes the errors command through the configured preview_tools module" do
      prev = Application.fetch_env!(:casein, :preview_tools)
      on_exit(fn -> Application.put_env(:casein, :preview_tools, prev) end)
      Application.put_env(:casein, :preview_tools, StubPreviewTools)
      ...
      # keeps Casein.Agents.PreviewTools out of Commands' compile graph
