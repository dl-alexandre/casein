...
defmodule DevIDE.FilePanesRemoteTest.RemoteSource do
  @moduledoc false
...
defmodule DevIDE.FilePanesRemoteTest do
  use DevIDE.DataCase, async: false

  alias DevIDE.FilePanes
  alias DevIDE.FilePanesRemoteTest.RemoteSource
  ...
  setup do
    ...
    prev_src = Application.get_env(:dev_ide, :workspace_source)
    prev_ssh = Application.get_env(:dev_ide, :ssh_runner)
    Application.put_env(:dev_ide, :tmux_adapter, FakeAdapter)
    Application.put_env(:dev_ide, :workspace_source, RemoteSource)
