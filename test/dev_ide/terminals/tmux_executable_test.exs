defmodule Casein.Terminals.TmuxExecutableTest do
  ...
  test "explicit executable is used by host argv" do
    ...
    Application.put_env(:dev_ide, :tmux_executable, path)
  ...
  test "environment override wins over application config" do
    ...
    Application.put_env(:dev_ide, :tmux_executable, config_path)
  ...
  test "nonexistent overrides are ignored" do
    Application.put_env(:dev_ide, :tmux_executable, "/definitely/missing/tmux")
    System.put_env("DEV_IDE_TMUX_EXECUTABLE", "/also/missing/tmux")

    assert TmuxExecutable.resolve() == System.find_executable("tmux")
  end

  defp restore_app_env(nil), do: Application.delete_env(:dev_ide, :tmux_executable)
  defp restore_app_env(value), do: Application.put_env(:dev_ide, :tmux_executable, value)
