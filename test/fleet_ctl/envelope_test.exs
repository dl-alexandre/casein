defmodule FleetCtl.EnvelopeTest do
  ...
  test "valid_uuid? accepts canonical UUIDs" do
    ...
    refute Envelope.valid_uuid?("550e8400-e29b-41d4-a716")
    refute Envelope.valid_uuid?(nil)
    refute Envelope.valid_uuid?(123)
  end
  ...
  test "valid_datetime? accepts DateTime structs only" do
    ...
    refute Envelope.valid_datetime?(~N[2026-01-01 00:00:00])
    refute Envelope.valid_datetime?(nil)
  end
end
